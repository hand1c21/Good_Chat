...
// // class AuthService {
// //   final FirebaseAuth _firebaseAuth = FirebaseAuth.instance; //אימות משתמשים
// //   final FirebaseFirestore _firebaseFirestore =
// //       FirebaseFirestore.instance; //מסד נתונים(צאט)
...
// //   String getErrorMesage(String errorCode) {
// //     switch (errorCode) {
// //       case 'Exception:wrong-password':
// //         return 'סיסמא שגויה תאנא נסה שוב';
// //       case 'Exception:user-not-found':
// //         return 'אנא הירשם,לא נמצא משתמש עם הדוא"ל הזה';
